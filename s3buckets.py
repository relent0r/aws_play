...
s3_client = boto3.client('s3', aws_access_key_id=aws_secret_key_id, aws_secret_access_key=aws_secret_access_key, region_name=aws_region_name)
...
s3_client.put_object(Bucket=bucket_name, Key=object_key, Body=b'Hello World!')
...
s3resource = boto3.resource('s3', aws_access_key_id=aws_secret_key_id, aws_secret_access_key=aws_secret_access_key, region_name=aws_region_name)
